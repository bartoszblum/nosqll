...
```js
mongoimport -d bblum -c air -type csv --headerline --file On_Time_On_Time_Performance_2014_10.csv
mongoimport -d bblum -c air -type csv --headerline --file On_Time_On_Time_Performance_2014_11.csv
mongoimport -d bblum -c air -type csv --headerline --file On_Time_On_Time_Performance_2014_12.csv
```
Historia Procesora:
